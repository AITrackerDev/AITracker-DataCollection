...
class InstructionsScreen(ctk.CTkFrame):
    ...
    def __init__(self, root, screen_changer):
        ...
        _instructions_label = ctk.CTkLabel(self, text="After clicking continue, the app will generate a dot in a random location on the screen. While looking at it, press the space bar to take a picture. Please be sure to keep your head still while collecting data. The app will inform you if your eyes cannot be seen, but please be sure that the image of your eyes is your eyes. This process will repeat 100 times, and can take 5-10 minutes.")
